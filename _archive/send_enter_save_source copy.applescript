on run argv
    ...
    if pageSourceHTML is not "" and pageSourceHTML is not missing value then
        ...
        set pythonResult to do shell script "/Users/robert/Documents/dev/workspace/experiments/perplexity_spoof/.venv/bin/python src/extract_json_from_html.py " & quoted form of outputHtmlFilePOSIX
        return pythonResult
    else
